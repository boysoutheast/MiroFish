...
from ..utils.locale import get_output_language_instruction, get_locale, set_locale, t
...
- persona必须是一段连贯的文字描述
- {get_output_language_instruction()} (gender字段必须用英文male/female)
- 内容要与实体信息保持一致
...
- {get_output_language_instruction()} (gender字段必须用英文"other")
